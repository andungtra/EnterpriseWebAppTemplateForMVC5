...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(EnterpriseApp.Presentation.Web.App_Start.FontAwesomeBundleConfig), "RegisterBundles")]
...
namespace EnterpriseApp.Presentation.Web.App_Start
{
	public class FontAwesomeBundleConfig
	{
		public static void RegisterBundles()
		{
			...
			BundleTable.Bundles.Add(new StyleBundle("~/Content/fontawesome").Include("~/Content/fontawesome/font-awesome1.css"));
		}
	}
}